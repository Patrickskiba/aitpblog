...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { company: @donation.company, currentTech: @donation.currentTech, pointOfContact: @donation.pointOfContact, reason: @donation.reason }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { company: @donation.company, currentTech: @donation.currentTech, pointOfContact: @donation.pointOfContact, reason: @donation.reason }
    assert_redirected_to donation_path(assigns(:donation))
  end
